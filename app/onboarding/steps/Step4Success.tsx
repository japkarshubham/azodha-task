    ...
    <div className="flex flex-col items-center gap-6 text-center">
      ...
      <div className="relative">
        {profile.profilePicture ? (
          ...
          <div className="flex h-20 w-20 items-center justify-center rounded-full bg-green-100 dark:bg-green-900 text-3xl">
            🎉
          </div>
        )}
        <span className="absolute -bottom-1 -right-1 flex h-7 w-7 items-center justify-center rounded-full bg-green-500 text-white text-sm shadow">
          ✓
        </span>
      </div>
      ...
      {/* Summary */}
      <div className="w-full rounded-xl border border-zinc-100 dark:border-zinc-800 divide-y divide-zinc-100 dark:divide-zinc-800 text-left text-sm">
